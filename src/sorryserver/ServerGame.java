...
public class ServerGame {
	...
	public String processBroadcast(Mailbox player, String msg) {
		...
		if(split[1].equals(MessageConstants.DECREMENT)) {
			return MessageConstants.DECREMENT;
		}
		if(split[1].equals(MessageConstants.RESTART)){
			return MessageConstants.RESTART;
		}
		if(split[1].equals(MessageConstants.STOP)){
			return MessageConstants.STOP;
		}
		if(split[1].equals(MessageConstants.TIMERSTART)) {
			return MessageConstants.TIMERSTART;
		}
		return "";
	}
